        ...
        publications {
            create<MavenPublication>("mavenJava") {
                pom {
                    ...
                    organization {
                        name.set("SonarSource and Waleri Enns")
                        url.set("http://www.sonarqube.org/")
                    }
                    licenses {
                        license {
                    ...
                    scm {
                        url.set("https://github.com/SonarSource/sonar-python")
                    }
                    developers {
                        developer {
...
sonarqube {
    properties {
        ...
        property("sonar.links.scm", "https://github.com/SonarSource/sonar-python")
...
artifactory {
    clientConfig.info.buildName = "sonar-python"
    ...
    clientConfig.info.addEnvironmentProperty("ARTIFACTS_TO_PUBLISH", "${project.group}:sonar-python-plugin:jar")
