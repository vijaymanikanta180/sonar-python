...
dependencies {
    ...
    implementation("org.sonarsource.sonarlint.core:sonarlint-plugin-api")
    implementation("$projectGroupId:python-frontend:$projectVersion")
    implementation("$projectGroupId:python-checks:$projectVersion")
    ...
    implementation("org.sonarsource.sslr:sslr-testing-harness")
    implementation("commons-lang:commons-lang")
    implementation("org.codehaus.staxmate:staxmate")
    implementation("org.sonarsource.sonarqube:sonar-testing-harness")
    testImplementation("org.sonarsource.sonarqube:sonar-plugin-api-impl:$sonarVersion")
